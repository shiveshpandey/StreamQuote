...
public final class Decimal implements Comparable<Decimal> {
	...
	public static final MathContext MATH_CONTEXT = new MathContext(32,
	...
	/**
	 * Returns the correctly rounded natural logarithm (base e) of the
	 * <code>double</code> value of this {@code Decimal}. /!\ Warning! Uses the
	 * {@code StrictMath#log(double)} method under the hood.
	 * 
	...
	/**
	 * Returns the correctly rounded positive square root of the
	 * <code>double</code> value of this {@code Decimal}. /!\ Warning! Uses the
	 ...
	 * @param other
	 *            the other value, not null
	 * @return true is this is greater than or equal to the specified value,
	 *         false otherwise
	 */
	 ...
	 * @param other
	 *            the other value, not null
	 * @return true is this is less than or equal to the specified value, false
	 *         otherwise
	 */
	 ...
	 *         {@code Decimal} and {@code other}. If they are equal, as defined
	 *         by the {@link #compareTo(Decimal) compareTo} method, {@code this}
	 *         is returned.
	 */
	...
	public int hashCode() {
		int hash = 7;
		hash = 53 * hash
				+ (this.delegate != null ? this.delegate.hashCode() : 0);
		return hash;
	}

	/**
	 * {@inheritDoc} Warning: This method returns true if `this` and `obj` are
	 * both NaN.
	 */
	@Override
	public boolean equals(Object obj) {
		...
		if (this.delegate != other.delegate
				&& (this.delegate == null || (this.delegate
						.compareTo(other.delegate) != 0))) {
			return false;
		}
		return true;
	}
